export const config = {
	mapTitle: 'blue-cards', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://blue-cards.vercel.app/', // The url provided when deploying the map on Vercel
	datasetType: 'values', // "values" or "binary"; Does the data set contain numerical values or binary (0/1) values for countries?
	datasetUnit: 'values', // "fullNumbers" or "percent"; Is the data in percent (0.25 of GDP) or full numbers (25 people)?
